...
10. verify the changed execution surfaces named by the active plan, not just the module as an undifferentiated whole
11. produce both:
...
16. classify deviations with the shared severity meanings defined by `specflow/framework/docs/agent_guidelines/severity_policy.md`
17. conclude:
