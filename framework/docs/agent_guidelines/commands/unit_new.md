...
Only a new independent full-scope run of `unit_new` may produce that advancing result; later local confirmation or scoped follow-up review must not advance lifecycle state.
